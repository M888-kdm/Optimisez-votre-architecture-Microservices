        ...
        <nav className="navbar navbar-expand-lg px-4 py-3 d-flex justify-content-between">
            ...
            <div className='d-flex col-1 justify-content-between'>
                <div className='d-flex me-4'>
                    ...
                    <Link href="/products" className='nav-link fw-bold'>Products</Link>
                </div>
                <div className='d-flex'>
                    ...
                    <Link href="/commandes" className='nav-link fw-bold'>Commandes</Link>
                </div>
            </div>
            
            <Link className="navbar-brand text-uppercase fw-bold col-2 mx-auto text-center" href="/">E-commerce</Link>
            ...
            <div className="d-flex justify-content-end align-items-center" id="navbarNav">
                <Link className="nav-link" href="/auth/login">
                    <button className='btn d-flex align-items-center ms-3 px-4 py-3 bg-dark text-white'>
